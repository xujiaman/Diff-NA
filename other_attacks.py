...
def model_selection(name):
    if name == "convnext":
        ...
        model_path = 'pretrained_models/jx_mixer_b16_224-76587d61.pth'
        ...
        model_path = 'pretrained_models/jx_mixer_l16_224-92f9adc4.pth'
        model_dict = torch.load(model_path)
...
def model_transfer(clean_img, adv_img, label, res, save_path=r"C:\Users\PC\Desktop\output", fid_path=None, args=None, niqe=0, brisque=0):
    ...
    print("\n*********niqe: {}********".format(niqe), file=log)
    print("\n*********brisque: {}********".format(brisque), file=log)
